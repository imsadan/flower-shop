...
<div id="templatemo_main">
    ...
    <div id="content" class="right">
      	<h2>订单详情</h2>
      	<table border="0" id="table" width="700px;"> 
        <tr>
           <td style="color:orange">订单号</td>
           <td style="color:orange">价格</td>
           <td style="color:orange">数量</td>
           <td style="color:orange">花名</td>
         </tr> 
         <c:forEach var="p" items="${itemOrder}">
           <tr>
             <td>${p.orderid}</td>
